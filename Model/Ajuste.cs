namespace sisgesoriadao.Model
{
    public class Ajuste
    {
        ...
        public byte DisenhoBoleta { get; set; }
        ...
        public Ajuste(byte idAjuste, double cambioDolar, byte limiteDescuento, byte intervaloHora, byte temaPredeterminado, byte disenhoBoleta, string fechaActualizacion)
        {
            IdAjuste = idAjuste;
