...
namespace sisgesoriadao.Interfaces
{
    public interface IProducto : IDao<Producto>
    {
        ...
        String GetCodeFormatToInsertProducts(int IdLote, byte Suma);
        ...
        DataTable SelectLikeInventoryOnlyQuantityFilter(string cadenaBusqueda, string idSucursales, string idCondiciones, string idCategorias, int mayor_o_igual_que, int menor_o_igual_que);
        //LOTES
        ...
        //TRANSFERENCIAS
        string InsertTransaction(List<Producto> ListaProductos, int idLote, string nombreProveedor, List<Double> PagosSublote);
        DataTable SelectProviderNamesForComboBox();
